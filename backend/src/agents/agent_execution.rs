            ...
            Scheduler::plan(mode).iter().enumerate()
        {
            ...
            for agent in agents {
                ...
                for round in 0..MAX_ROUNDS {
                    ...
                    let input_size =
                        serde_json::to_vec(&messages)?.len();
                    ...
                    for (index, call) in
                        turn.tool_calls.iter().enumerate()
                    {
                        total_calls += 1;
                        ...
                        let name = function
                            ...
                            .context(
                                "Nom d'outil manquant"
                            )?;

                        let raw_arguments = function
                            .get("arguments")
                            .context(
                                "Arguments d'outil manquants"
                            )?;
                ...
                if !finished {
                    bail!(
                        "Limite des tours avec outils atteinte"
                    );
                }
